...
export const changePassword = (data) =>
  network.post("/api/person/changePassword", data);

// upload files
export const uploadFile = (data) =>
  network.post("/api/campaign/upload", data, true);
...
export const getIndustries = () =>
  network.get("/api/wholesalepricing/getIndustries");

export const getStates = (country) =>
  network.publicGet(`/pub/states/${country}`);
...
export const getAllCampaign = () =>
  network.post("/api/campaign/getAllcampaigns/");
