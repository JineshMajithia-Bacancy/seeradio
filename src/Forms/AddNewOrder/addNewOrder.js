    ...
    <>
      ...
      <div className="addNewOrderBackground">
        <div className="addNewOrder">
          <Row>
            <Col className="backgroundGrey m-3">Order</Col>
          </Row>
          <Row>
            <Col md={6}>
              <SelectField
            ...
            <Col md={6}>
              <FloatingInput
                errrMessage="Please Enter Valid Title"
                error={data.title.touched && !data.title.valid}
                name="title"
                onChange={onChangeHandler}
          ...
          <Row>
            <Col md={6}>
              <FloatingInput
                errrMessage="Please Enter Valid Preffered Landing URL"
                error={
                  data.prefferedLandingPageUrl.touched &&
                  !data.prefferedLandingPageUrl.valid
                }
                name="prefferedLandingPageUrl"
                onChange={onChangeHandler}
                value={data.prefferedLandingPageUrl.value}
                type="name"
                label="Preffered Landing Page URL"
                placeholder="Preffered Landing Page URL"
                id="prefferedLandingPageURL"
                for="floatingInput"
              />
            </Col>
            <Col md={6}>
              <FloatingInput
                errrMessage="Please Enter Valid Price"
                error={data.price.touched && !data.price.valid}
                name="price"
                onChange={onChangeHandler}
          ...
          <Row>
            <Col md={6}>
              <FloatingInput
                errrMessage="Please Enter Valid Description"
                error={data.description.touched && !data.description.valid}
                name="description"
                id="description"
                label="description"
          ...
          <Row>
            <Col className="backgroundGrey m-3">Distribution</Col>
          </Row>
          <Row>
            <Col md={6}>
              <SelectField
            ...
            <Col md={6}>
              <FloatingInput
                errrMessage="Please Enter Valid Budget"
                error={data.budget.touched && !data.budget.valid}
                name="budget"
                onChange={onChangeHandler}
          ...
          <Row>
            <Col>
              ...
              <Button
                ...
                className="addOrderCancelButton"
              >
                Cancel
              </Button>
              <Button
                disabled={true}
                className="addOrderBackButton"
                color="primary"
                onClick={previous}
              >
                <i
                  className="fa fa-angle-double-left pr-1"
                  aria-hidden="true"
                ></i>
                Back
              </Button>
...
const mapDispatchToProps = (dispatch) => {
  return {
    setOrderResponseData: (data) =>
      dispatch(actions.setOrderFormResponse(data)),
  };
};
