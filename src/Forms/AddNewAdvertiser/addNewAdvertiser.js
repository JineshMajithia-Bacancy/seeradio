...
function AddNewAdvertiser({
  ...
  const onChangeHandler = (event, name) => {
    if (name) {
      ...
      if (name === "country") {
        ...
        tempdata = {
          ...data,
          [name]: { value: event, touched: true, valid: isValid },
      ...
      if (event.target.name === "postal") {
        isValid = validationHandler(
          `postal${data.country.value.value}`,
          event.target.value
        );
      } else {
  ...
  const onSecondaryContactChangeHandler = (event, name) => {
    if (name) {
      ...
      let tempdata = {
        ...secondaryContact,
        [name]: { value: event.value, touched: true, valid: isValid },
      };
      let validated = submitButtonHandler(tempdata, data);
      setAdvertiserData({
        ...advertiserData,
        secondaryContact: tempdata,
        validated: validated,
      });
    } else {
  ...
  const onSecondaryBillingChangeHandler = (event, name) => {
    if (name) {
      ...
      if (event.target.name === "postal") {
        isValid = validationHandler(
          `postal${secondaryBilling.country.value.value}`,
          event.target.value
        );
      } else {
        isValid = validationHandler(event.target.name, event.target.value);
    ...
    secondaryContactForm = (
      <>
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid First Name"
              error={
                secondaryContact.firstName.touched &&
                !secondaryContact.firstName.valid
              }
              name="firstName"
              onChange={onSecondaryContactChangeHandler}
              value={secondaryContact.firstName.value}
              type="name"
              label="First Name"
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Last Name"
              error={
                secondaryContact.lastName.touched &&
                !secondaryContact.lastName.valid
              }
              name="lastName"
              onChange={onSecondaryContactChangeHandler}
              value={secondaryContact.lastName.value}
              type="name"
              label="Last Name"
        ...
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Email"
              error={
                secondaryContact.email.touched && !secondaryContact.email.valid
              }
              name="email"
              onChange={onSecondaryContactChangeHandler}
              value={secondaryContact.email.value}
              type="name"
              label="Email"
              placeholder="Email"
              id="Email"
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Phone"
              maxLength={12}
              error={
                secondaryContact.phone.touched && !secondaryContact.phone.valid
              }
              name="phone"
              onChange={onSecondaryContactChangeHandler}
              value={secondaryContact.phone.value}
              type="name"
              label="Phone"
              placeholder="Phone"
              id="Phone"
    ...
    secondaryBillingForm = (
      <>
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Address"
              error={
                secondaryBilling.address.touched &&
                !secondaryBilling.address.valid
              }
              name="address"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.address.value}
              type="address"
              label="Address"
              placeholder="Address"
              id="address2"
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Address"
              error={
                secondaryBilling.addressLine2.touched &&
                !secondaryBilling.addressLine2.valid
              }
              required="false"
              name="addressLine2"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.addressLine2.value}
              type="address"
              label="AddressLine2"
        ...
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid City"
              error={
                secondaryBilling.city.touched && !secondaryBilling.city.valid
              }
              name="city"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.city.value}
              type="name"
              label="City"
              placeholder="City"
              id="city2"
          ...
          <Col md={6}>
            <SelectField
              ...
              id="country2"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.country.value}
        ...
        <Row>
          <Col md={6}>
            <SelectField
              disabled={!advertiserData.secIsCountry}
              name="state"
              id="state2"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.state.value}
              options={secStateOptions}
              label="State"
            />
          </Col>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Postal"
              disabled={!advertiserData.secIsCountry}
              error={
                secondaryBilling.postal.touched &&
                !secondaryBilling.postal.valid
              }
              name="postal"
              onChange={onSecondaryBillingChangeHandler}
              value={secondaryBilling.postal.value}
              type="name"
              label="Postal"
              placeholder="Postal"
              id="postal"
    ...
    <>
      ...
      <div className="addNewAdvertiser">
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Company Name"
              name="companyName"
              error={data.companyName.touched && !data.companyName.valid}
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Company Website Address"
              error={
                data.companyWebsiteAddress.touched &&
                !data.companyWebsiteAddress.valid
              }
              name="companyWebsiteAddress"
              onChange={onChangeHandler}
              value={data.companyWebsiteAddress.value}
              type="name"
        ...
        <Row>
          <Col md={6}>
            <SelectField
              ...
              id="industryCategory"
              value={data.industryCategory.value}
              onChange={onChangeHandler}
        ...
        <Row>
          <Col className="backgroundGrey m-3">Primary Contact</Col>
        </Row>
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid First Name"
              error={data.firstName.touched && !data.firstName.valid}
              name="firstName"
              onChange={onChangeHandler}
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Last Name"
              error={data.lastName.touched && !data.lastName.valid}
              name="lastName"
              onChange={onChangeHandler}
        ...
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Email"
              error={data.email.touched && !data.email.valid}
              name="email"
              onChange={onChangeHandler}
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Phone"
              error={data.phone.touched && !data.phone.valid}
              maxLength={12}
              name="phone"
              onChange={onChangeHandler}
        ...
        <Row>
          <Col className="backgroundGrey mb-3 mx-3">
            <input
              ...
              id="secondaryContactCheck"
              className="secondaryContactCheck"
              onChange={onChangeHandler}
              checked={advertiserData.secondaryContactCheck}
              type="checkbox"
            />
        ...
        {secondaryContactForm}
        <Row>
          <Col className="backgroundGrey mx-3 mb-3">Business Address</Col>
        </Row>
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Address"
              error={data.address.touched && !data.address.valid}
              name="address"
              onChange={onChangeHandler}
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Address"
              error={data.addressLine2.touched && !data.addressLine2.valid}
              required="false"
              name="addressLine2"
              onChange={onChangeHandler}
        ...
        <Row>
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid City"
              error={data.city.touched && !data.city.valid}
              name="city"
              onChange={onChangeHandler}
        ...
        <Row>
          <Col md={6}>
            <SelectField
              disabled={!advertiserData.isCountry}
              name="state"
              id="state"
              onChange={onChangeHandler}
          ...
          <Col md={6}>
            <FloatingInput
              errrMessage="Please Enter Valid Postal"
              disabled={!advertiserData.isCountry}
              error={data.postal.touched && !data.postal.valid}
              name="postal"
              onChange={onChangeHandler}
              value={data.postal.value}
              type="name"
              label="Postal"
              placeholder="Postal"
              id="postal"
        ...
        <Row>
          <Col className="backgroundGrey mx-3">
            <input
              name="secondaryBillingAddressCheck"
              className="secondaryContactCheck"
              onChange={onChangeHandler}
              checked={advertiserData.secondaryBillingAddressCheck}
              type="checkbox"
            />
        ...
        <Row>
          <Col>
            <Button
              disabled={!advertiserData.validated}
              className="addAdvertiserButton"
              color="primary"
              onClick={createAdvertiserHandler}
            >
              Create Advertiser
              <i
                className="fa fa-angle-double-right pl-1"
                aria-hidden="true"
              ></i>
            </Button>
            <Button
              className="addAdvertiserCancelButton"
...
const mapDispatchToProps = (dispatch) => {
  return {
    setClientResponseData: (data) =>
      dispatch(actions.setClientFormResponse(data)),
  };
};
